...
TEMPLATE.src = "images/twibbon.png"; // Ganti jika path berbeda

let userImage = null;
let imgX = 0, imgY = 0, imgScale = 1;
let isDragging = false, dragStartX = 0, dragStartY = 0;

// Posisi lingkaran pada desain
const circleCenterX = 384;
const circleCenterY = 540;
