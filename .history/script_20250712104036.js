...
TEMPLATE.src = "images/twibbon.png"; // Pastikan PNG ini transparan di tengah
...
upload.addEventListener("change", function () {
    ...
    reader.onload = function (e) {
        ...
        userImage.onload = function () {
            ...
            // Hitung skala agar gambar penuh menutupi lingkaran
            const scaleX = targetSize / userImage.width;
            const scaleY = targetSize / userImage.height;

            // Gunakan skala terbesar (agar tidak ada area putih)
            ...
            // Pusatkan gambar
            imgX = 384 - newWidth / 2; // tengah canvas
...
function shareImage() {
    canvas.toBlob(function (blob) {
        ...
        if (navigator.canShare && navigator.canShare({ files: [file] })) {
            ...
            alert("Browser tidak mendukung share otomatis. Silakan unggah manual ke Instagram/WA.");
        }
    });
}
